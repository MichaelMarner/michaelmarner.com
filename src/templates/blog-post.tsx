            ...
            <div className="nav-previous">
              {previous.frontmatter.featured_image?.childImageSharp?.fluid && (
                <div className="nav-background">
                  <Img
                    fluid={
                      previous.frontmatter.featured_image?.childImageSharp
                        ?.fluid
                    }
                  />
                </div>
              ...
              <Link to={previous.fields.slug} rel="prev">
                ...
                <span className="post-title">{previous.frontmatter.title}</span>
              </Link>
            </div>
          )}
          {next && (
            <div className="nav-next">
              ...
              <Link to={next.fields.slug} rel="prev">
                ...
                <span className="post-title">{next.frontmatter.title}</span>
              </Link>
            </div>
          )}
        </div>
